...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("labdesk".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../labdesk-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\labdesk\flutter\build\windows\runner\Debug\ -o . -e ..\labdesk\flutter\build\windows\runner\Debug\labdesk.exe
