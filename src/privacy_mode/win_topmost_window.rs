...
pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_labdesk.exe";
pub const INJECTED_PROCESS_EXE: &'static str = WIN_TOPMOST_INJECTED_PROCESS_EXE;
pub(super) const PRIVACY_WINDOW_CLASS: &'static str = "LabDeskPrivacyWindowClass";
pub(super) const PRIVACY_WINDOW_NAME: &'static str = "LabDeskPrivacyWindow";
