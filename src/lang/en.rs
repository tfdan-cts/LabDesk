...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the server..."),
        ...
        ("Slogan_tip", "Remote administration for the machines you look after."),
        ...
        ("whitelist_tip", "Only the IP addresses you list can connect to this device."),
        ...
        ("whitelist_sep", "Separate entries with a comma, semicolon, space or new line."),
        ("Add Tag", "Add tag"),
        ...
        ("Use IP Whitelisting", "Allowed IPs"),
        ...
        ("hide_cm_tip", "Only available when sessions require a permanent password."),
        ...
        ("empty_favorite_tip", "No favourites yet. Star a machine to keep it here."),
        ("empty_lan_tip", "No machines found on this network yet."),
        ("empty_address_book_tip", "Your address book is empty."),
        ...
        ("scam_title", "This could be a scam"),
        ("scam_text1", "If you are on the phone with someone you do not know and trust who has asked you to use RustDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("privacy_mode_impl_mag_tip", "Blank the physical monitor"),
        ("privacy_mode_impl_virtual_display_tip", "Switch to a virtual display"),
        ...
        ("powered_by_me", "Powered by LabDesk"),
        ("outgoing_only_desk_tip", "This build can start sessions but cannot accept them."),
        ("preset_password_warning", "This build comes with a preset password. Anyone knowing this password could gain full control of your device. If you did not expect this, uninstall the software immediately."),
        ("share_warning_tip", "The fields above are shared and visible to others."),
        ("ab_web_console_tip", "More on web console"),
        ("allow-only-conn-window-open-tip", "Only accept connections while RustDesk is open"),
        ...
        ("floating_window_tip", "Keeps the RustDesk background service alive."),
        ...
        ("server-oss-not-support-tip", "NOTE: the open-source RustDesk Server (OSS) does not include this feature."),
        ...
        ("id_whitelist_tip", "Only the IDs you list can connect to this device."),
        ("id_whitelist_wildcard_tip", "Wildcards are supported: '*' matches any number of characters, '?' matches exactly one character"),
        ("id_whitelist_caveat_tip", "The ID is reported by the connecting client. This list reduces exposure and does not replace the password or 2FA."),
        ...
        ("Active server profile", "Active server profile"),
        ...
        ("Not in recent sessions", "Not in recent sessions"),
