...
///
/// Note:
/// On linux, we use dbus to communicate between multiple labdesk processes.
...
const DBUS_NAME: &str = "org.labdesk.labdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "LabDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.labdesk.labdesk /dbus org.labdesk.labdesk.NewConnection string:'PEER_ID'`
