...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_PRINTER_PORT = L"LabDesk Printer";
    LPCWCH RD_PRINTER_NAME = L"LabDesk Printer";
    ...
    {
        // If the printer is used after the spooler service is started. E.g., printing a document through LabDesk Printer.
