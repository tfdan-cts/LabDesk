...
class MyTheme {
  ...
  static const Color accent50 = Color(0x777C3AED);
  static const Color accent80 = Color(0xAA7C3AED);
  static const Color canvasColor = Color(0xFF212121);
  static const Color border = Color(0xFFCCCCCC);
  static const Color idColor = Color(0xFFA78BFA);
  static const Color darkGray = Color.fromARGB(255, 148, 148, 148);
  static const Color cmIdColor = Color(0xFF21790B);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFF8B5CF6);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
        primary: Colors.deepPurple, secondary: accent, background: grayBg),
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://lab-desk.net'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
